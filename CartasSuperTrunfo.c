...
int main() {
    ...
    pib_per1 = (pib1 * 1000000000) / (float)populacao1; // Calcula o PIB per capita da Carta A
    ...
    pib_per2 = (pib2 * 1000000000) / (float) populacao2; // Calcula o PIB per capita da Carta B
